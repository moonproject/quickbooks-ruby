describe Quickbooks::Service::AccessToken do
  ...
  it 'can renew a token' do
    ...
    stub_http_request(:get, Quickbooks::Service::AccessToken::RENEW_URL, %w[200 OK], xml, {}, true)
  ...
  if ENV['OAUTH2'] == '1'
    it 'can successfully disconnect [oauth2]' do
      ...
      stub_http_request(:get, Quickbooks::Service::AccessToken::DISCONNECT_URL_OAUTH2, %w[200 OK], xml, {}, true)
