module Quickbooks
  module Model
    class InvoiceLineItem < BaseModel
      ...
      #== Constants
      SALES_LINE_ITEM_DETAIL = 'SalesItemLineDetail'.freeze
      ...
      INVOICE_GROUP_LINE_DETAIL = 'GroupLineDetail'.freeze
      DESCRIPTION_LINE_DETAIL = 'DescriptionLineDetail'.freeze
      DESCRIPTION_DETAIL_TYPE = 'DescriptionOnly'.freeze
      ...
      def sales_item!
        ...
        yield sales_line_item_detail if block_given?
      end
      ...
      def description_only!
        ...
        yield description_line_detail if block_given?
      end
    end
  end
end
