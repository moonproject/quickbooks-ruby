module Quickbooks
  module Model
    class Account < BaseModel
      XML_COLLECTION_NODE = 'Account'.freeze
      XML_NODE = 'Account'.freeze
      REST_RESOURCE = 'account'.freeze
      MINORVERSION = 13
      ...
      ACCOUNT_CLASSIFICATION = [ASSET, EQUITY, EXPENSE, LIABILITY, REVENUE].freeze
