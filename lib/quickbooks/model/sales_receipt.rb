module Quickbooks
  module Model
    class SalesReceipt < BaseModel
      ...
      XML_COLLECTION_NODE = 'SalesReceipt'.freeze
      XML_NODE = 'SalesReceipt'.freeze
      REST_RESOURCE = 'salesreceipt'.freeze
      ...
      alias email= billing_email_address= # backward backward compatibility to v0.4.6
    end
  end
end
