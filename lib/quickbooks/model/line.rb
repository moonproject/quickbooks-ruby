module Quickbooks
  module Model
    class Line < BaseModel
      ...
      #== Constants
      SALES_ITEM_LINE_DETAIL = 'SalesItemLineDetail'.freeze
      SUB_TOTAL_LINE_DETAIL = 'SubTotalLineDetail'.freeze
      PAYMENT_LINE_DETAIL = 'PaymentLineDetail'.freeze
      DISCOUNT_LINE_DETAIL = 'DiscountLineDetail'.freeze
      JOURNAL_ENTRY_LINE_DETAIL = 'JournalEntryLineDetail'.freeze
      ...
      def sub_total!
        ...
        yield sub_total_line_detail if block_given?
      end
      ...
      def payment!
        ...
        yield payment_line_detail if block_given?
      end
      ...
      def discount!
        ...
        yield discount_line_detail if block_given?
      end
      ...
      def journal_entry!
        ...
        yield journal_entry_line_detail if block_given?
      end
      ...
      def group_line!
        ...
        yield group_line_detail if block_given?
      end
