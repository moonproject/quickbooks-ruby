...
module Quickbooks
  module Model
    class Item < BaseModel
      XML_COLLECTION_NODE = 'Item'.freeze
      XML_NODE = 'Item'.freeze
      REST_RESOURCE = 'item'.freeze
      MINORVERSION = 33

      INVENTORY_TYPE = 'Inventory'.freeze
      NON_INVENTORY_TYPE = 'NonInventory'.freeze
      SERVICE_TYPE = 'Service'.freeze
      CATEGORY_TYPE = 'Category'.freeze
      ITEM_TYPES = [INVENTORY_TYPE, NON_INVENTORY_TYPE, SERVICE_TYPE, CATEGORY_TYPE].freeze
