...
module Quickbooks
  module Model
    class Invoice < BaseModel
      ...
      #== Constants
      REST_RESOURCE = 'invoice'.freeze
      XML_COLLECTION_NODE = 'Invoice'.freeze
      XML_NODE = 'Invoice'.freeze
      EMAIL_STATUS_NEED_TO_SEND = 'NeedToSend'.freeze
      MINORVERSION = 37
      ...
      alias total_amount= total=
      alias home_total_amount home_total
      alias home_total_amount= home_total=
      ...
      def required_bill_email_if_email_delivery
        ...
        errors.add(:bill_email, 'BillEmail is required if EmailStatus=NeedToSend') if bill_email.nil?
      end
